# Topic 01-readme.md - awesome API documentation

> Source: [documentation/01-readme.md.html](https://awesomewm.org/doc/api/documentation/01-readme.md.html)
...
NOTE: Awesome uses [`cmake`](<https://cmake.org>) to build. In case you want to pass arguments to cmake, please use the `CMAKE_ARGS` environment variable. For instance:
...
Awesome has the following dependencies (besides a more-or-less standard POSIX environment):
  ...
  * [libxcb >= 1.6](<https://xcb.freedesktop.org/>) with support for the RandR, XTest, Xinerama, SHAPE and XKB extensions
  ...
  * [libstartup-notification >= 0.10](<https://www.freedesktop.org/wiki/Software/startup-notification/>)
  * [cairo](<https://www.cairographics.org/>) with support for XCB and GObject introspection
  * [Pango](<http://www.pango.org/>) with support for Cairo and GObject introspection
  * [GLib >= 2.40](<https://wiki.gnome.org/Projects/GLib>) with support for GObject introspection
  * [GIO](<https://developer.gnome.org/gio/stable/>) with support for GObject introspection
...
Additionally, the following optional dependencies exist:
  ...
  * [DBus](<https://www.freedesktop.org/wiki/Software/dbus/>) for DBus integration and the `awesome-client` utility
  * [asciidoctor](<https://asciidoctor.org/>) for generating man pages
  * [gzip](<http://www.gzip.org/>) for compressing man pages
  * [ldoc >= 1.4.5](<https://stevedonovan.github.io/ldoc/>) for generating the documentation
  ...
  * [LuaCov](<https://keplerproject.github.io/luacov/>) for collecting code coverage information
...
You can call [awesome](<../libraries/awesome.html#>) with `gdb` like this:
