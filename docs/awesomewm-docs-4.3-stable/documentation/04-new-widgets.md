# Topic 04-new-widgets.md - awesome API documentation

> Source: [documentation/04-new-widgets.md.html](https://awesomewm.org/doc/api/documentation/04-new-widgets.md.html)

---

# Creating new widget

All widgets have to be generated by the [wibox.widget.base.make_widget](<../classes/wibox.widget.base.html#wibox.widget.base.make_widget>) function so that the needed signals are added and mouse input handling is set up.
